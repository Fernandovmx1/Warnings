report 70350 "BSS Standard Sales Order Conf."
{
    RDLCLayout = './BSSStandardSalesOrderConf.rdlc';
    WordLayout = './BSSStandardSalesOrderConf.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(TotalQuantity; format(TotalQuantity, 0, '<Integer>'))
            {
            }
            dataitem(Line; "Sales Line")
            {
                ...
                begin
                    ...
                    SaleslineL.SetRange(Type, Type::Item);
                    if SaleslineL.CalcSums(Quantity) then
                        TotalQuantity := SaleslineL.Quantity;
